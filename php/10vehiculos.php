...
<?php
	...
	if((($_SESSION["txt_rangousuario"]) == "PROFESIONAL")	|| (($_SESSION["txt_rangousuario"]) == "BODEGUERO") || (($_SESSION["txt_rangousuario"]) == "ADMINISTRATIVO") || (($_SESSION["txt_rangousuario"]) == "ALCALDE"))
	{
	...
	<div align="center">
		<table width="1024" class="tres">
			...
			<tr>
				<td></td>
				<td>
					<form id="vehic" name="vehic" method="Post" action="<?=$_SERVER['PHP_SELF'];?>">
						<input type="submit" name="ivehic" id="ivehic" value="Ingresar." class="botonmenu" />
						<input type="submit" name="vvehic" id="vvehic" value="Ver Bitacora." class="botonmenu" />						
					</form>		
				</td>
			</tr>
		</table>	
