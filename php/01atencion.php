...
Archivo		:	01atencion.php
Proposito	:	Atención Usuarios.
...
<?php
	...
	if((($_SESSION["txt_rangousuario"]) == "BODEGUERO")	|| (($_SESSION["txt_rangousuario"]) == "CONDUCTOR") || (($_SESSION["txt_rangousuario"]) == "ADMINISTRATIVO"))
	{
	...
	<div align="center">
		<table width="1024" class="tres">
			...
			<tr>
				<td></td>
				<td>
					<form id="atencion" name="atencion" method="Post" action="<?=$_SERVER['PHP_SELF'];?>">
						<input type="submit" name="gatencion" id="gatencion" value="Generar." class="botonmenu" />
						<input type="submit" name="aatencion" id="aatencion" value="Atencion." class="botonmenu" />
						<input type="submit" name="vatencion" id="vatencion" value="Ver." class="botonmenu" />
					</form>		
				</td>
			</tr>
		</table>	
