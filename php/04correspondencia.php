...
Archivo		:	04correspondencia.php
Proposito	:	Correspondencia.
	...
	<div align="center">
		<table width="1024" class="tres">
			...
			<tr>
				<td></td>
				<td>
					<form id="corresp" name="corresp" method="Post" action="<?=$_SERVER['PHP_SELF'];?>">
						<input type="submit" name="icorresp" id="icorresp" value="Ingresar." class="botonmenu" />
						<input type="submit" name="vcorresp" id="vcorresp" value="Ver." class="botonmenu" />
					</form>		
				</td>
			</tr>
		</table>	
