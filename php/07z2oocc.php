...
<?php
	...
	if((($_SESSION["txt_rangousuario"]) == "PROFESIONAL") || (($_SESSION["txt_rangousuario"]) == "BODEGUERO") || (($_SESSION["txt_rangousuario"]) == "CONDUCTOR") || (($_SESSION["txt_rangousuario"]) == "ADMINISTRATIVO") || (($_SESSION["txt_rangousuario"]) == "ALCALDE"))
	{
