...
<?php
	...
	if((($_SESSION["txt_rangousuario"]) == "CONDUCTOR") || (($_SESSION["txt_rangousuario"]) == "ADMINISTRATIVO"))
	{
	...
	<div align="center">
		<table width="1024" class="tres">
			...
			<tr>
				<td></td>
				<td>
					<form id="person" name="person" method="Post" action="<?=$_SERVER['PHP_SELF'];?>">
						<input type="submit" name="iperson" id="iperson" value="Ingresar." class="botonmenu" />
						<input type="submit" name="vperson" id="vperson" value="Ver." class="botonmenu" />						
					</form>		
				</td>
			</tr>
		</table>	
